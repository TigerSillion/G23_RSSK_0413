...
***********************************************************************************************************************/
/***********************************************************************************************************************
* Touch I/F Configuration File  : G23_RSSK_0412.tifcfg
* Tuning Log File               : G23_RSSK_0412_log_tuning20250412141533.log
***********************************************************************************************************************/
...
/***********************************************************************************************************************
Related Information for [Diagnosis] configuration.
***********************************************************************************************************************/

const ctsu_cfg_t g_qe_ctsu_cfg_diagnosis =
{
    .md    = CTSU_MODE_DIAGNOSIS_SCAN,
    .p_callback    = &qe_touch_callback,

};

ctsu_instance_ctrl_t g_qe_ctsu_ctrl_diagnosis;

const ctsu_instance_t g_qe_ctsu_instance_diagnosis =
{
    .p_ctrl = &g_qe_ctsu_ctrl_diagnosis,
    .p_cfg  = &g_qe_ctsu_cfg_diagnosis,
...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x12D, .snum = 0x07, .sdpa = 0x05 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x113, .snum = 0x07, .sdpa = 0x05 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x10F, .snum = 0x07, .sdpa = 0x05 },
