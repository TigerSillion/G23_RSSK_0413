...
src/smc_gen/Config_TAU0_0/%.obj: ../src/smc_gen/Config_TAU0_0/%.c 
	...
	ccrl -subcommand="src\smc_gen\Config_TAU0_0\cDepSubCommand.tmp" -o "$(@:%.obj=%.d)" -MT="$(@:%.obj=%.obj)" -MT="$(@:%.obj=%.d)" -msg_lang=japanese "$<"
	@echo src\smc_gen\Config_TAU0_0\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\Config_TAU0_0\cSubCommand.tmp"
	ccrl -subcommand="src\smc_gen\Config_TAU0_0\cSubCommand.tmp" -msg_lang=japanese -o "$(@:%.d=%.obj)" "$<"
