...
src/smc_gen/rm_touch/%.obj: ../src/smc_gen/rm_touch/%.c 
	...
	ccrl -subcommand="src\smc_gen\rm_touch\cDepSubCommand.tmp" -o "$(@:%.obj=%.d)" -MT="$(@:%.obj=%.obj)" -MT="$(@:%.obj=%.d)" -msg_lang=japanese "$<"
	@echo src\smc_gen\rm_touch\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\rm_touch\cSubCommand.tmp"
	ccrl -subcommand="src\smc_gen\rm_touch\cSubCommand.tmp" -msg_lang=japanese -o "$(@:%.d=%.obj)" "$<"
